...
/*
* Method for updating dropdown list of individuals that can check into an event
...
function changeIndividualOptionsBasedOnEventCheckIn(selectObj) {
    ...
    var individualSelect = document.getElementById("indCheckIn");
    console.log(individualSelect)
    var newOption;
    var rawResponseJson;
    ...
    rawResponse.then(function (rawResponse) {
        ...
        rawResponseJson.then(function (rawResponseJson) {
            ...
            console.log(individualSelect.id)
        })
